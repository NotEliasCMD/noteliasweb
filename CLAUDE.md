...
banner in `script.js`) prints a celebration and plays a short Web Audio chime
(`playChime()`, no asset). Swap the trigger word/output/sound there; the terminal
stays `aria-hidden`. See `COMPONENTS.md` §3.
